...
namespace FastDev.Editor
{
    ...
    public static class LogScriptingDefineSymbols
    {
        ...
        /// 禁用所有日志脚本宏定义。
        /// </summary>
        [MenuItem("FastDev/Log Scripting Define Symbols/Disable All Logs", false, 30)]
        ...
        /// 开启所有日志脚本宏定义。
        /// </summary>
        [MenuItem("FastDev/Log Scripting Define Symbols/Enable All Logs", false, 31)]
        ...
        /// 开启调试及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("FastDev/Log Scripting Define Symbols/Enable Debug And Above Logs", false, 32)]
        ...
        /// 开启信息及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("FastDev/Log Scripting Define Symbols/Enable Info And Above Logs", false, 33)]
        ...
        /// 开启警告及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("FastDev/Log Scripting Define Symbols/Enable Warning And Above Logs", false, 34)]
        ...
        /// 开启错误及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("FastDev/Log Scripting Define Symbols/Enable Error And Above Logs", false, 35)]
        ...
        /// 开启严重错误及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("FastDev/Log Scripting Define Symbols/Enable Fatal And Above Logs", false, 36)]
